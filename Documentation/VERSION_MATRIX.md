...
This is contained by decision D-008: no Uludağ Formula file outside `AFVehicleCompatibilityLayer.h/.cpp` names any engine vehicle type. That containment is statically enforced by `Tools/af_static_validate.py` and has not weakened.
